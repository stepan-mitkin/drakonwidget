function createDrakonWidget() {
    ...
    function drakon_canvas() {
        ...
        function addTextToDiv(options, config, textDiv, text) {
        ...
        function flowTextBlock(block, width) {
            var flowBlock, top, left, right, options, last, diff, size, lineWidth, actualWidth, _var2, _var3, _var4, line, _var7, _var8, _var9, _var10, _var5, _var6;
            var __state = '2';
            while (true) {
                switch (__state) {
                    case '2':
        ...
        function addHtmltoDom(html, parentElement) {
            var parser, doc, body, name, firstNode, _var2, _var3, node;
            var __state = '2';
            while (true) {
                switch (__state) {
                    case '2':
                    ...
                    case '18':
                        if (_var3 < _var2.length) {
                            node = _var2[_var3];
                            addNodeToDom(node, parentElement);
                            _var3++;
                            __state = '18';
                        } else {
                            __state = '4';
        ...
        function addNodeToDom(node, parentElement) {
                ...
                switch (__state) {
                    case '5':
                        ...
                        if (visuals.config.canvasIcons) {
                            ...
                            node.textBlock = createTextBlock(visuals.ctx, text, toptions);
                            ...
                            if (options.singleLine) {
                                ...
                                addTextToDiv(options, config, textDiv, text);
                                __state = '_item6';
                            }
                        }
                        break;
            ...
            while (true) {
                switch (__state) {
                    case '5':
                        ...
                        addTextToDiv(options, config, topDiv, secondary);
                        node.topDiv = topDiv;
                        __state = '50';
                        break;
                    case '22':
                    ...
                    case '50':
                        ...
                        addTextToDiv(options, config, bottomDiv, text);
                        __state = '59';
                        break;
                    case '57':
                        options2 = {
        ...
        function splitHtmlTextNode(text, type) {
            var state, buffer, line, ch, whitespace, length, i;
            var __state = '2';
            while (true) {
                switch (__state) {
                    case '2':
